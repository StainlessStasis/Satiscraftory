...
public record ResourceNodeConfig(BlockState markerState, BlockState oreState, IntProvider radius) implements FeatureConfiguration {
    public static final Codec<ResourceNodeConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            BlockState.CODEC.fieldOf("resource_state").forGetter(ResourceNodeConfig::oreState),
