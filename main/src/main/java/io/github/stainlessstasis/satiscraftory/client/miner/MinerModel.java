...
public class MinerModel extends Model<MinerRenderState> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r25 = light5.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(302, 349).addBox(-1.3244F, -1.7373F, -2.0F, 1.0F, 5.0F, 9.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r26 = light6.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(302, 363).addBox(-3.0F, -2.0F, 5.0F, 1.0F, 5.0F, 9.0F, new CubeDeformation(0.0F))
		...
		PartDefinition power_indicator = root.addOrReplaceChild("power_indicator", CubeListBuilder.create().texOffs(248, 346).addBox(-9.5F, -46.0F, 4.0F, 3.0F, 24.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition drill_ring = drill_head.addOrReplaceChild("drill_ring", CubeListBuilder.create().texOffs(364, 0).addBox(-10.0F, -10.0F, -10.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(150, 364).addBox(8.0F, -10.0F, -10.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -11.0F, 6.0F));

		PartDefinition cube_r27 = drill_ring.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(366, 130).addBox(-1.0F, -2.0F, -4.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, -15.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r28 = drill_ring.addOrReplaceChild("cube_r28", CubeListBuilder.create().texOffs(366, 119).addBox(-1.0F, -2.0F, -4.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, 3.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r29 = drill_ring.addOrReplaceChild("cube_r29", CubeListBuilder.create().texOffs(130, 364).addBox(-17.5F, -2.1F, 5.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(364, 85).addBox(-0.5F, -2.1F, 5.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-12.0F, -8.0F, -5.25F, 0.0F, 2.3562F, 0.0F));

		PartDefinition cube_r30 = drill_ring.addOrReplaceChild("cube_r30", CubeListBuilder.create().texOffs(364, 74).addBox(16.5F, -2.1F, 4.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(364, 11).addBox(-0.5F, -2.1F, 4.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-12.0F, -8.0F, -5.25F, 0.0F, 0.7854F, 0.0F));

		PartDefinition drill_ring_2 = drill_head.addOrReplaceChild("drill_ring_2", CubeListBuilder.create().texOffs(260, 366).addBox(7.0F, -38.0F, 15.5F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(72, 369).addBox(-9.0F, -38.0F, 15.5F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 20.0F, -19.0F));

		PartDefinition cube_r31 = drill_ring_2.addOrReplaceChild("cube_r31", CubeListBuilder.create().texOffs(368, 354).addBox(-18.0F, -2.0F, -12.5F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(368, 60).addBox(-34.0F, -2.0F, -12.5F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, -36.0F, -6.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r32 = drill_ring_2.addOrReplaceChild("cube_r32", CubeListBuilder.create().texOffs(368, 50).addBox(-4.75F, -2.1F, -27.5F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(356, 366).addBox(-19.75F, -2.1F, -27.5F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, -36.0F, -6.0F, 0.0F, 2.3562F, 0.0F));

		PartDefinition cube_r33 = drill_ring_2.addOrReplaceChild("cube_r33", CubeListBuilder.create().texOffs(338, 366).addBox(-32.75F, -2.1F, 7.75F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(278, 366).addBox(-17.5F, -2.1F, 7.75F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, -36.0F, -6.0F, 0.0F, 0.7854F, 0.0F));
		...
		PartDefinition drill_ring_3 = drill_head.addOrReplaceChild("drill_ring_3", CubeListBuilder.create().texOffs(102, 346).addBox(7.0F, -38.0F, 22.5F, 2.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(322, 367).addBox(-7.0F, -38.0F, 22.5F, 2.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 23.0F, -25.5F));

		PartDefinition cube_r34 = drill_ring_3.addOrReplaceChild("cube_r34", CubeListBuilder.create().texOffs(370, 333).addBox(-29.75F, -2.1F, -17.25F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(370, 323).addBox(-17.0F, -2.1F, -17.25F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -36.0F, 0.0F, 0.0F, 2.3562F, 0.0F));

		PartDefinition cube_r35 = drill_ring_3.addOrReplaceChild("cube_r35", CubeListBuilder.create().texOffs(370, 185).addBox(-21.0F, -2.1F, 18.75F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(370, 175).addBox(-8.5F, -2.1F, 18.75F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -36.0F, 0.0F, 0.0F, 0.7854F, 0.0F));

		PartDefinition cube_r36 = drill_ring_3.addOrReplaceChild("cube_r36", CubeListBuilder.create().texOffs(370, 343).addBox(-33.5F, -2.0F, 3.0F, 2.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(370, 96).addBox(-19.5F, -2.0F, 3.0F, 2.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -36.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition cube_r37 = drill_ring_4.addOrReplaceChild("cube_r37", CubeListBuilder.create().texOffs(372, 267).addBox(-10.5F, -1.1F, -25.25F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(372, 260).addBox(-19.75F, -1.1F, -25.25F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, -36.0F, 0.0F, 0.0F, 2.3562F, 0.0F));

		PartDefinition cube_r38 = drill_ring_4.addOrReplaceChild("cube_r38", CubeListBuilder.create().texOffs(372, 253).addBox(-28.25F, -1.1F, 11.75F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(170, 371).addBox(-19.0F, -1.1F, 11.75F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, -36.0F, 0.0F, 0.0F, 0.7854F, 0.0F));

		PartDefinition cube_r39 = drill_ring_4.addOrReplaceChild("cube_r39", CubeListBuilder.create().texOffs(104, 371).addBox(-32.0F, -1.0F, -8.5F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(90, 371).addBox(-22.0F, -1.0F, -8.5F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, -36.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition drill_ring_5 = drill_head.addOrReplaceChild("drill_ring_5", CubeListBuilder.create().texOffs(260, 360).addBox(-2.0F, -1.0F, 24.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(118, 371).addBox(-8.0F, -1.0F, 24.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, -9.0F, -26.0F));

		PartDefinition cube_r40 = drill_ring_5.addOrReplaceChild("cube_r40", CubeListBuilder.create().texOffs(372, 280).addBox(-2.0F, -1.0F, 22.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-28.5F, 0.0F, 28.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r41 = drill_ring_5.addOrReplaceChild("cube_r41", CubeListBuilder.create().texOffs(372, 274).addBox(-2.0F, -1.0F, 22.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-28.5F, 0.0F, 22.0F, 0.0F, 1.5708F, 0.0F));
