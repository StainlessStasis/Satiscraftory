...
public class MinerModel extends Model<MinerRenderState> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition port_frame = miner.addOrReplaceChild("port_frame", CubeListBuilder.create().texOffs(214, 79).addBox(-2.005F, -20.0F, -2.0F, 4.005F, 20.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(26, 336).addBox(-18.0F, -20.0F, -2.0F, 4.005F, 20.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(350, 350).addBox(-14.0F, -4.0F, -2.0F, 12.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(354, 147).addBox(-14.0F, -20.0F, -2.0F, 12.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = base_frame_right.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(356, 26).addBox(8.005F, 18.5F, 13.5F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 38.25F, 0.9163F, 0.0F, 0.0F));

		PartDefinition cube_r5 = base_frame_right.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(104, 355).addBox(8.005F, 18.5F, -21.5F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 105.75F, -0.9163F, 0.0F, 0.0F));

		PartDefinition cube_r6 = base_frame_right.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(354, 169).addBox(8.005F, 18.5F, -21.5F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 67.0F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition base_frame_left = miner.addOrReplaceChild("base_frame_left", CubeListBuilder.create().texOffs(320, 311).addBox(-12.0F, -0.25F, 5.0F, 4.0F, 2.0F, 19.0F, new CubeDeformation(0.0F))
				...
				.texOffs(270, 333).addBox(-12.0F, -0.25F, 81.35F, 4.0F, 2.0F, 11.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r9 = base_frame_left.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(356, 199).addBox(-12.005F, 18.5F, 13.5F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 38.25F, 0.9163F, 0.0F, 0.0F));

		PartDefinition cube_r10 = base_frame_left.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(356, 189).addBox(-12.005F, 18.5F, -21.5F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 105.75F, -0.9163F, 0.0F, 0.0F));

		PartDefinition cube_r11 = base_frame_left.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(356, 179).addBox(-12.005F, 18.5F, -21.5F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 67.0F, -0.9163F, 0.0F, 0.0F));

		PartDefinition cube_r12 = base_frame_left.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(356, 36).addBox(-12.005F, 18.5F, 13.5F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -0.5F, 0.9163F, 0.0F, 0.0F));
		...
		PartDefinition base_frame = miner.addOrReplaceChild("base_frame", CubeListBuilder.create().texOffs(230, 144).addBox(-28.0F, -0.25F, 1.0F, 40.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
				...
				.texOffs(0, 353).addBox(0.0F, -2.25F, 91.35F, 4.0F, 5.0F, 9.0F, new CubeDeformation(0.0F))
				.texOffs(354, 155).addBox(-20.0F, -2.25F, 91.35F, 4.0F, 5.0F, 9.0F, new CubeDeformation(0.0F))
		...
		PartDefinition tower_foot = right.addOrReplaceChild("tower_foot", CubeListBuilder.create().texOffs(0, 336).addBox(13.0F, -6.5F, 52.0F, 5.0F, 9.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(334, 0).addBox(6.0F, -6.5F, 52.0F, 7.0F, 4.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(340, 53).addBox(1.0F, -6.5F, 52.0F, 5.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition tower_foot2 = right.addOrReplaceChild("tower_foot2", CubeListBuilder.create().texOffs(78, 340).addBox(13.0F, -6.5F, 52.0F, 5.0F, 9.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(270, 346).addBox(6.0F, -6.5F, 52.0F, 7.0F, 4.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(138, 340).addBox(1.0F, -6.5F, 52.0F, 5.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 33.0F));

		PartDefinition left = tower_feet.addOrReplaceChild("left", CubeListBuilder.create(), PartPose.offset(-16.0F, 0.0F, 0.0F));

		PartDefinition tower_foot3 = left.addOrReplaceChild("tower_foot3", CubeListBuilder.create().texOffs(344, 70).addBox(-18.0F, -6.5F, 52.0F, 5.0F, 9.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(200, 347).addBox(-13.0F, -6.5F, 52.0F, 7.0F, 4.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(344, 87).addBox(-6.0F, -6.5F, 52.0F, 5.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition tower_foot4 = left.addOrReplaceChild("tower_foot4", CubeListBuilder.create().texOffs(344, 257).addBox(-18.0F, -6.5F, 52.0F, 5.0F, 9.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(320, 347).addBox(-13.0F, -6.5F, 52.0F, 7.0F, 4.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(344, 274).addBox(-6.0F, -6.5F, 52.0F, 5.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 33.0F));
		...
		PartDefinition top = miner.addOrReplaceChild("top", CubeListBuilder.create().texOffs(74, 153).addBox(-15.0F, -120.0F, 64.0F, 14.0F, 57.0F, 17.0F, new CubeDeformation(0.0F))
				...
				.texOffs(350, 133).addBox(-3.0F, -113.0F, 94.0F, 8.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition drill_head = drill.addOrReplaceChild("drill_head", CubeListBuilder.create().texOffs(0, 266).addBox(-18.0F, -20.9688F, 62.0F, 20.0F, 0.0F, 20.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition drill_ring = drill_head.addOrReplaceChild("drill_ring", CubeListBuilder.create().texOffs(356, 209).addBox(-10.0F, -10.0F, -10.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(358, 104).addBox(8.0F, -10.0F, -10.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(-8.0F, -11.0F, 78.0F));

		PartDefinition cube_r27 = drill_ring.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(270, 358).addBox(-1.0F, -2.0F, -4.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, -15.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r28 = drill_ring.addOrReplaceChild("cube_r28", CubeListBuilder.create().texOffs(358, 115).addBox(-1.0F, -2.0F, -4.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, 3.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r29 = drill_ring.addOrReplaceChild("cube_r29", CubeListBuilder.create().texOffs(358, 12).addBox(-17.5F, -2.1F, 5.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(128, 357).addBox(-0.5F, -2.1F, 5.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-12.0F, -8.0F, -5.25F, 0.0F, 2.3562F, 0.0F));

		PartDefinition cube_r30 = drill_ring.addOrReplaceChild("cube_r30", CubeListBuilder.create().texOffs(78, 357).addBox(16.5F, -2.1F, 4.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(356, 220).addBox(-0.5F, -2.1F, 4.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-12.0F, -8.0F, -5.25F, 0.0F, 0.7854F, 0.0F));

		PartDefinition drill_ring_2 = drill_head.addOrReplaceChild("drill_ring_2", CubeListBuilder.create().texOffs(358, 291).addBox(7.0F, -38.0F, 15.5F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(362, 244).addBox(-9.0F, -38.0F, 15.5F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(-8.0F, 20.0F, 53.0F));

		PartDefinition cube_r31 = drill_ring_2.addOrReplaceChild("cube_r31", CubeListBuilder.create().texOffs(26, 360).addBox(-18.0F, -2.0F, -12.5F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(320, 359).addBox(-34.0F, -2.0F, -12.5F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, -36.0F, -6.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r32 = drill_ring_2.addOrReplaceChild("cube_r32", CubeListBuilder.create().texOffs(218, 359).addBox(-4.75F, -2.1F, -27.5F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(200, 359).addBox(-19.75F, -2.1F, -27.5F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, -36.0F, -6.0F, 0.0F, 2.3562F, 0.0F));

		PartDefinition cube_r33 = drill_ring_2.addOrReplaceChild("cube_r33", CubeListBuilder.create().texOffs(350, 358).addBox(-32.75F, -2.1F, 7.75F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(358, 301).addBox(-17.5F, -2.1F, 7.75F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, -36.0F, -6.0F, 0.0F, 0.7854F, 0.0F));

		PartDefinition drill_ring_3 = drill_head.addOrReplaceChild("drill_ring_3", CubeListBuilder.create().texOffs(148, 357).addBox(7.0F, -38.0F, 22.5F, 2.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(254, 361).addBox(-7.0F, -38.0F, 22.5F, 2.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-9.0F, 23.0F, 46.5F));

		PartDefinition cube_r34 = drill_ring_3.addOrReplaceChild("cube_r34", CubeListBuilder.create().texOffs(236, 365).addBox(-29.75F, -2.1F, -17.25F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(98, 365).addBox(-17.0F, -2.1F, -17.25F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -36.0F, 0.0F, 0.0F, 2.3562F, 0.0F));

		PartDefinition cube_r35 = drill_ring_3.addOrReplaceChild("cube_r35", CubeListBuilder.create().texOffs(364, 0).addBox(-21.0F, -2.1F, 18.75F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(44, 363).addBox(-8.5F, -2.1F, 18.75F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -36.0F, 0.0F, 0.0F, 0.7854F, 0.0F));

		PartDefinition cube_r36 = drill_ring_3.addOrReplaceChild("cube_r36", CubeListBuilder.create().texOffs(290, 365).addBox(-33.5F, -2.0F, 3.0F, 2.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(62, 364).addBox(-19.5F, -2.0F, 3.0F, 2.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -36.0F, 0.0F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition drill_ring_4 = drill_head.addOrReplaceChild("drill_ring_4", CubeListBuilder.create().texOffs(66, 286).addBox(7.0F, -37.0F, 23.5F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(66, 293).addBox(-3.0F, -37.0F, 23.5F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-11.0F, 25.0F, 46.0F));

		PartDefinition cube_r37 = drill_ring_4.addOrReplaceChild("cube_r37", CubeListBuilder.create().texOffs(306, 365).addBox(-10.5F, -1.1F, -25.25F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(290, 358).addBox(-19.75F, -1.1F, -25.25F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, -36.0F, 0.0F, 0.0F, 2.3562F, 0.0F));

		PartDefinition cube_r38 = drill_ring_4.addOrReplaceChild("cube_r38", CubeListBuilder.create().texOffs(358, 126).addBox(-28.25F, -1.1F, 11.75F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(356, 46).addBox(-19.0F, -1.1F, 11.75F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, -36.0F, 0.0F, 0.0F, 0.7854F, 0.0F));
		...
		PartDefinition drill_ring_5 = drill_head.addOrReplaceChild("drill_ring_5", CubeListBuilder.create().texOffs(338, 359).addBox(-2.0F, -1.0F, 24.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(116, 365).addBox(-8.0F, -1.0F, 24.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, -9.0F, 46.0F));

		PartDefinition cube_r40 = drill_ring_5.addOrReplaceChild("cube_r40", CubeListBuilder.create().texOffs(366, 53).addBox(-2.0F, -1.0F, 22.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-28.5F, 0.0F, 28.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r41 = drill_ring_5.addOrReplaceChild("cube_r41", CubeListBuilder.create().texOffs(338, 365).addBox(-2.0F, -1.0F, 22.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-28.5F, 0.0F, 22.0F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition drill_ring_6 = drill_head.addOrReplaceChild("drill_ring_6", CubeListBuilder.create().texOffs(158, 38).addBox(-10.0F, -8.5F, 70.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(66, 217).addBox(-9.0F, -7.5F, 71.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
