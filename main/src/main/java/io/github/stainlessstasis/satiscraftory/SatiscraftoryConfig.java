...
public class SatiscraftoryConfig {
    ...
    public static final ModConfigSpec.IntValue RESOURCE_SCANNER_RANGE = BUILDER
            .comment("Maximum range, in blocks, at which the Resource Scanner can detect nodes within. " +
            ...
            .defineInRange("resourceScannerRange", 1000, 1, 100000);
